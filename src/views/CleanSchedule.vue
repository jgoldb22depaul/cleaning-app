                  ...
                  <tr v-for="result in results" :key="result.uid" :style="{ color: '#CC5500'}">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-4 py-2 whitespace-nowrap text-center text-sm font-medium hover:bg-red-50">
                          <input @click="CancelAppt(result.rid)" type="button" value="Cancel Appointment" class=" rounded-2xl py-2 px-4 font-thin cursor-pointer ml-2 bg-gray-200 hover:bg-gray-300" :style = "{backgroundColor: '#FD3A4A', color: '#F8FFE5'}">   
                      </td>    
                      </tr>  
